...
// Main File List
Alias: $CS_TH_FileList = https://terms.sil-th.org/CodeSystem/cs-th-file-list
...
// Social History
Alias: $CS_Meta_SocialObsType = https://terms.sil-th.org/CodeSystem/cs-meta-social-obs-type
...
// Death
Alias: $CS_43File_PidRemoveReason = https://terms.sil-th.org/CodeSystem/cs-43file-pid-remove-reason
...
Alias: $CS_Meta_ParticipantType = https://terms.sil-th.org/CodeSystem/cs-meta-participant-type
Alias: $CS_eClaim_ProviderType = https://terms.sil-th.org/CodeSystem/cs-eclaim-provider-type
Alias: $CS_Meta_ProviderTypeCoverage = https://terms.sil-th.org/CodeSystem/cs-meta-provider-type-coverage


// Allergy
Alias: $CS_Std15_AllergyVerify = https://terms.sil-th.org/CodeSystem/cs-std15-allergy-verify 
Alias: $CS_THCC_AllergyManifest = https://terms.sil-th.org/CodeSystem/cs-thcc-allergy-manifest
Alias: $CS_THCC_AllergyCertainty = https://terms.sil-th.org/CodeSystem/cs-thcc-allergy-certainty
Alias: $CS_THCC_AllergySeverity = https://terms.sil-th.org/CodeSystem/cs-thcc-allergy-severity
Alias: $CS_THCC_AllergyAssertType = https://terms.sil-th.org/CodeSystem/cs-thcc-allergy-assert-type

// Functional
Alias: $CS_THCC_FunctionalTest = https://terms.sil-th.org/CodeSystem/cs-thcc-functional-test
Alias: $CS_THCC_FunctionalConclusion = https://terms.sil-th.org/CodeSystem/cs-thcc-functional-conclusion

// Encounter
Alias: $CS_43Plus_ServicePriority = https://terms.sil-th.org/CodeSystem/cs-43plus-service-priority
Alias: $CS_THCC_AdmitSource = https://terms.sil-th.org/CodeSystem/cs-thcc-admit-source
Alias: $CS_THCC_PatientLocationType = https://terms.sil-th.org/CodeSystem/cs-thcc-patient-location-type
Alias: $CS_THCC_ServiceHour = https://terms.sil-th.org/CodeSystem/cs-thcc-service-hour
Alias: $CS_PCU_ServiceLocationType = https://terms.sil-th.org/CodeSystem/cs-pcu-service-location-type
Alias: $CS_eClaim_ServiceTypeTH = https://terms.sil-th.org/CodeSystem/cs-eclaim-service-type-th
...
Alias: $CS_THCC_IpdDischargeStatus = https://terms.sil-th.org/CodeSystem/cs-thcc-ipd-discharge-status
Alias: $CS_THCC_IpdDischargeType = https://terms.sil-th.org/CodeSystem/cs-thcc-ipd-discharge-type
Alias: $CS_THCC_ChronicDischargeReason = https://terms.sil-th.org/CodeSystem/cs-thcc-chronic-discharge-reason

// Surveillance
Alias: $CS_THCC_SurvGroup = https://terms.sil-th.org/CodeSystem/cs-thcc-surveillance-group
Alias: $CS_THCC_DiseaseCause = https://terms.sil-th.org/CodeSystem/cs-thcc-disease-cause
Alias: $CS_PCU_ClnicalStatus = https://terms.sil-th.org/CodeSystem/cs-pcu-clnical-status


// Accident
Alias: $CS_Meta_AccidentObs = https://terms.sil-th.org/CodeSystem/cs-meta-accident-obs
Alias: $CS_THCC_AccidentLocation = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-location
Alias: $CS_THCC_AccidentAdmitSource = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-admit-source
Alias: $CS_THCC_AccidentPatientType = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-patient-type
Alias: $CS_THCC_AccidentVehicle = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-vehicle
Alias: $CS_THCC_AccidentBreathing = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-breathing
Alias: $CS_THCC_AccidentBleeding = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-bleeding
Alias: $CS_THCC_AccidentSplint = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-splint
Alias: $CS_THCC_AccidentIVFluid = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-iv-fluid
Alias: $CS_THCC_AccidentPriority = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-priority
Alias: $CS_THCC_AccidentCauseGroup = https://terms.sil-th.org/CodeSystem/cs-thcc-accident-cause-group
Alias: $CS_eClaim_AccidentCoverage = https://terms.sil-th.org/CodeSystem/cs-eclaim-accident-coverage

// Appointment
Alias: $CS_Std15_AppointServiceCategory = https://terms.sil-th.org/CodeSystem/cs-std15-appoint-service-category
Alias: $CS_THCC_AppointServiceType = https://terms.sil-th.org/CodeSystem/cs-thcc-appoint-service-type

// NCD
Alias: $CS_43Plus_NcdStatus = https://terms.sil-th.org/CodeSystem/cs-43plus-ncd-status
Alias: $CS_THCC_NcdSmoking = https://terms.sil-th.org/CodeSystem/cs-thcc-ncd-smoking
Alias: $CS_THCC_NcdAlcohol = https://terms.sil-th.org/CodeSystem/cs-thcc-ncd-alchohol
Alias: $CS_THCC_NcdFbsMethod = https://terms.sil-th.org/CodeSystem/cs-thcc-ncd-fbs-method
Alias: $CS_THCC_NcdFootExam = https://terms.sil-th.org/CodeSystem/cs-thcc-ncd-foot-exam
Alias: $CS_THCC_NcdRetinaExam = https://terms.sil-th.org/CodeSystem/cs-thcc-ncd-retina-exam

// Woman Health
Alias: $CS_THCC_NoContraceptive = https://terms.sil-th.org/CodeSystem/cs-thcc-no-contraceptive

// Pregnancy
Alias: $CS_PCU_FpCaseType = https://terms.sil-th.org/CodeSystem/cs-pcu-fp-case-type
Alias: $CS_THCC_ContraceptiveMethod = https://terms.sil-th.org/CodeSystem/cs-thcc-contraceptive-method
Alias: $CS_Meta_MiscPregnancyObs = https://terms.sil-th.org/CodeSystem/cs-meta-misc-pregnancy-obs
Alias: $CS_Meta_ScreeningResult = https://terms.sil-th.org/CodeSystem/cs-meta-screening-result
Alias: $CS_THCC_LaborPerformerRole = https://terms.sil-th.org/CodeSystem/cs-thcc-labor-performer-role
Alias: $CS_THCC_LaborProcedure = https://terms.sil-th.org/CodeSystem/cs-thcc-labor-procedure
Alias: $CS_THCC_LaborLocation = https://terms.sil-th.org/CodeSystem/cs-thcc-labor-location
Alias: $CS_PCU_LaborPresentation = https://terms.sil-th.org/CodeSystem/cs-pcu-labor-presentation
Alias: $CS_PCU_PostnatalBreastfeeding = https://terms.sil-th.org/CodeSystem/cs-pcu-postnatal-breastfeeding
Alias: $CS_PCU_PostnatalMens = https://terms.sil-th.org/CodeSystem/cs-pcu-postnatal-mens
Alias: $CS_PCU_PostnatalPerineum = https://terms.sil-th.org/CodeSystem/cs-pcu-postnatal-perineum

// Pediatrics
Alias: $CS_THCC_NewbornFood = https://terms.sil-th.org/CodeSystem/cs-thcc-newborn-food
Alias: $CS_THCC_ChildDevLevel = https://terms.sil-th.org/CodeSystem/cs-thcc-child-dev-level
Alias: $CS_THCC_ChildFood = https://terms.sil-th.org/CodeSystem/cs-thcc-child-food

// Referral
Alias: $CS_THCC_ReferReason = https://terms.sil-th.org/CodeSystem/cs-thcc-refer-in-reason
Alias: $CS_43Plus_ReferReason = https://terms.sil-th.org/CodeSystem/cs-43plus-refer-reason
Alias: $CS_Std15_ReferReason = https://terms.sil-th.org/CodeSystem/cs-std15-refer-reason
Alias: $CS_eClaim_ReferReason = https://terms.sil-th.org/CodeSystem/cs-eclaim-refer-reason-eclaim
Alias: $CS_43File_ReferEncounterClass = https://terms.sil-th.org/CodeSystem/cs-43file-refer-encounter-class
Alias: $CS_THCC_ReferThaiPriority = https://terms.sil-th.org/CodeSystem/cs-thcc-refer-thai-priority
Alias: $CS_eClaim_ReferThaiPriority = https://terms.sil-th.org/CodeSystem/cs-eclaim-refer-thai-priority
Alias: $CS_eClaim_ReferPriorityCode = https://terms.sil-th.org/CodeSystem/cs-eclaim-refer-priority-code
Alias: $CS_eClaim_ReferTypeEclaim = https://terms.sil-th.org/CodeSystem/cs-eclaim-refer-type-eclaim
Alias: $CS_43File_ReferCareProcedure = https://terms.sil-th.org/CodeSystem/cs-43file-refer-care-procedure
Alias: $CS_Std15_ReferStatus = https://terms.sil-th.org/CodeSystem/cs-std15-refer-status
Alias: $CS_Std15_ReferAnswerType = https://terms.sil-th.org/CodeSystem/cs-std15-refer-answer-type
Alias: $CS_PCU_ReferOutcome = https://terms.sil-th.org/CodeSystem/cs-pcu-refer-outcome
Alias: $CS_43File_ReferResult = https://terms.sil-th.org/CodeSystem/cs-43file-refer-result
Alias: $CS_43File_ReferSpecialDisease = https://terms.sil-th.org/CodeSystem/cs-43file-refer-special-disease


// Medication
Alias: $CS_Std15_MedicationSource = https://terms.sil-th.org/CodeSystem/cs-std15-medication-source
Alias: $CS_eClaim_MedicationCategory = https://terms.sil-th.org/CodeSystem/cs-eclaim-medication-category
Alias: $CS_eClaim_MedNedCriteria = https://terms.sil-th.org/CodeSystem/cs-eclaim-medication-ned-criteria
Alias: $CS_43Plus_MedDelivery = https://terms.sil-th.org/CodeSystem/cs-43plus-medication-delivery

// Procedure
Alias: $CS_eClaim_ProcedureType = https://terms.sil-th.org/CodeSystem/cs-eclaim-procedure-type
...
// Cancer
Alias: $CS_43Plus_CancerDxSource = https://terms.sil-th.org/CodeSystem/cs-43plus-cancer-dx-source
Alias: $CS_43Plus_CancerGrade = https://terms.sil-th.org/CodeSystem/cs-43plus-cancer-grade
Alias: $CS_43Plus_CancerStaging = https://terms.sil-th.org/CodeSystem/cs-43plus-cancer-staging
Alias: $CS_eClaim_CancerType = https://terms.sil-th.org/CodeSystem/cs-eclaim-cancer-type
...
Alias: $CS_THCC_2DigitLab = https://terms.sil-th.org/CodeSystem/cs-thcc-2digit-lab
Alias: $CS_THCC_CausativeAgent = https://terms.sil-th.org/CodeSystem/cs-thcc-causative-agent
Alias: $CS_THCC_RehabDevice = https://terms.sil-th.org/CodeSystem/cs-thcc-rehab-device
Alias: $CS_THCC_RehabServiceType = https://terms.sil-th.org/CodeSystem/cs-thcc-rehab-service-type
Alias: $CS_THCC_PregnancyOutcome = https://terms.sil-th.org/CodeSystem/cs-thcc-pregnancy-outcome
Alias: $CS_THCC_VaccineCode = https://terms.sil-th.org/CodeSystem/cs-thcc-vaccine-code
Alias: $CS_THCC_SpecialPPService = https://terms.sil-th.org/CodeSystem/cs-thcc-special-pp-service
